...
signal Cards_Add(sidejob1, jobadd, lvl, LAR)
signal  Interarea_Comun(SJ1, JA, LAR)
...
#	选择初始副职
	if sidejob1 == -1:
		lvl = 0
		sidejob1 = JobAdd
		Global.sidejob1 = JobAdd
		LevelAddingRestrict[0] = 1
		emit_signal("Cards_Add",Global.sidejob1, JobAdd, lvl, LevelAddingRestrict)
		emit_signal("Interarea_Comun", sidejob1, JobAdd, LevelAddingRestrict)
	elif sidejob1 == JobAdd:
		popup_panel.popup()
...
func _on_筑基_pressed():
	if LevelAddingRestrict[1] == 0 and JobAdd == Global.sidejob1:
		lvl = 1
		emit_signal("Cards_Add",Global.sidejob1, JobAdd, lvl, LevelAddingRestrict)
		emit_signal("Interarea_Comun", sidejob1, JobAdd, LevelAddingRestrict)
...
func _on_金丹_pressed():
	if LevelAddingRestrict[2] == 0 and JobAdd == Global.sidejob1:
		lvl = 2
		emit_signal("Cards_Add",Global.sidejob1, JobAdd, lvl, LevelAddingRestrict)
		emit_signal("Interarea_Comun", sidejob1, JobAdd, LevelAddingRestrict)
...
func _on_元婴_pressed():
	if LevelAddingRestrict[3] == 0 and JobAdd == Global.sidejob1:
		lvl = 3
		emit_signal("Cards_Add",Global.sidejob1, JobAdd, lvl, LevelAddingRestrict)
		emit_signal("Interarea_Comun", sidejob1, JobAdd, LevelAddingRestrict)
...
func _on_化神_pressed():
	if LevelAddingRestrict[4] == 0 and JobAdd == Global.sidejob1:
		lvl = 4
		emit_signal("Cards_Add",Global.sidejob1, JobAdd, lvl, LevelAddingRestrict)
		emit_signal("Interarea_Comun", sidejob1, JobAdd, LevelAddingRestrict)
...
func _on_side_job_21_interarea_comun(SJ2: Variant, JA: Variant, LAR: Variant) -> void:
	JobAdd = JA
	LevelAddingRestrict = LAR

func _on_side_job_22_interarea_comun(SJ2: Variant, JA: Variant, LAR: Variant) -> void:
	JobAdd = JA
	LevelAddingRestrict = LAR

func _on_side_job_23_interarea_comun(SJ2: Variant, JA: Variant, LAR: Variant) -> void:
	JobAdd = JA
	LevelAddingRestrict = LAR
